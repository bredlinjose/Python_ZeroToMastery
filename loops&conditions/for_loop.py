...
for letter in letters:  # same like foreach loop in java
    print(letter)  # here it will print only values
...
for index, letter in enumerate(
        letters):  # enumerate will return tuples (index, value of index) that we are storing in index, letter
    print(index, letter)
